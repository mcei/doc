Контекстом называют реализацию интерфейса `Context` из пакета `context`, который входит в стандартную библиотеку Go (начиная с версии 1.7).
...
Контекст используется для того, чтобы передавать данные запросов, устанавливать таймауты и делать явную отмену в цепочке вложенных функций или горутин.
